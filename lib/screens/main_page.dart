  ...
  BottomNavigationBar _bottomNavigationBar() {
    return BottomNavigationBar(
      ...
      items: <BottomNavigationBarItem>[
        BottomNavigationBarItem(icon: iconList[0], label: 'Anasayfa'),
        BottomNavigationBarItem(icon: iconList[1], label: 'Favoriler'),
        BottomNavigationBarItem(icon: iconList[2], label: 'Profil'),
      ],
    );
  }
}
